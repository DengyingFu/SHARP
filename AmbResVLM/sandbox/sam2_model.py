...
checkpoint = ASSETS_DIR.WEIGHTS / "sam2.1_hiera_large.pt"
model_cfg = "configs/sam2.1/sam2.1_hiera_l.yaml"  # do not touch this value
predictor = SAM2ImagePredictor(build_sam2(str(model_cfg), checkpoint, device=DEVICE))

# with torch.inference_mode(), torch.autocast("cuda", dtype=torch.bfloat16):
#     predictor.set_image(your_image)
#     masks, _, _ = predictor.predict(input_prompts)

image = Image.open(ASSETS_DIR.IMAGES / "table_top.png")
...
print("Images embedding shape: ", predictor._features["image_embed"].shape)
